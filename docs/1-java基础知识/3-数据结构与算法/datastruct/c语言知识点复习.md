...
网站：https://www.tutorialspoint.com/c_standard_library/c_function_malloc.htm

## 函数

### [malloc 函数](https://www.tutorialspoint.com/c_standard_library/c_function_malloc.htm)使用
