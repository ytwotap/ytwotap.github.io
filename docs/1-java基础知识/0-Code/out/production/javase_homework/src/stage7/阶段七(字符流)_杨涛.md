...
import src.stage7.utils.Parsing;
import src.stage7.utils.ScannerUtils;
import src.stage7.entity.Student;
import src.stage7.entity.StudentList;
...
//        加几个Student对象作为数组的初始值
        //new object
        BufferedReader read = new BufferedReader(new FileReader("stage7_storage_file.txt"));
        //read
        String studentStringData;
        while ((studentStringData = read.readLine()) != null) {
            Student student = new Student();
            //操作字符串 获取特定位置数据
            //parse
            String stuId = parsing.parsing("stuId", studentStringData);
            String name = parsing.parsing("name", studentStringData);
            String gender = parsing.parsing("gender", studentStringData);
            String grade = parsing.parsing("grade", studentStringData);
            String age = parsing.parsing("age", studentStringData);
            String phoneNum = parsing.parsing("phoneNum", studentStringData);
            if (stuId != null) {
...
//    }
    ...
    private void consoleUpdateStudent() {
        ...
        if (sls.judgeStuIdExist(targetStuId)) {
            //学号存在,可以修改
            Student updateStu = src.stage7.utils.ScannerUtils.getStudentInstanceByScanner(sls);
            /*
...
public class StudentList {
    ...
    public void updateFile() {
        try {
            writer = new BufferedWriter(new FileWriter("stage7_storage_file.txt"));
            for (Student ss : studs) { //for
                if (ss != null) {
                    //write one
...
![image-20210703224746567](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703224746567.png)

![image-20210703224853187](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703224853187.png)

![image-20210703224900718](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703224900718.png)

![image-20210703224927129](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703224927129.png)

![image-20210703224933172](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703224933172.png)

![image-20210703225317824](../../../../../../../AppData/Roaming/Typora/typora-user-images/image-20210703225317824.png)
